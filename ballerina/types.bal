...
public type InlineResponse2003AllOf1 record {
    ...
    record {@jsondata:Name {value: "file_path"}
        string filePath?; @jsondata:Name {value: "play_url"}
        string playUrl?; @jsondata:Name {value: "meeting_id"}
        string meetingId?; @jsondata:Name {value: "file_size"}
        decimal fileSize?; @jsondata:Name {value: "recording_end"}
        string recordingEnd?; @jsondata:Name {value: "file_type"}
        "MP4"|"M4A"|"CHAT"|"TRANSCRIPT"|"CSV"|"TB"|"CC"|"CHAT_MESSAGE"|"SUMMARY" fileType?; @jsondata:Name {value: "recording_type"}
        "shared_screen_with_speaker_view(CC)"|"shared_screen_with_speaker_view"|"shared_screen_with_gallery_view"|"active_speaker"|"gallery_view"|"shared_screen"|"audio_only"|"audio_transcript"|"chat_file"|"poll"|"host_video"|"closed_caption"|"timeline"|"thumbnail"|"audio_interpretation"|"summary"|"summary_next_steps"|"summary_smart_chapters"|"sign_interpretation"|"production_studio" recordingType?; @jsondata:Name {value: "download_url"}
        string downloadUrl?; @jsondata:Name {value: "file_extension"}
        "MP4"|"M4A"|"TXT"|"VTT"|"CSV"|"JSON"|"JPG" fileExtension?; string id?; @jsondata:Name {value: "deleted_time"}
        string deletedTime?; @jsondata:Name {value: "recording_start"}
        string recordingStart?; "completed" status?;}[] recordingFiles?;
};
...
public type RegistrationList3 record {
    ...
    record {string id?; string zip?; string country?; @jsondata:Name {value: "custom_questions"}
        record {string title?; string value?;}[] customQuestions?; @jsondata:Name {value: "purchasing_time_frame"}
        ""|"Within a month"|"1-3 months"|"4-6 months"|"More than 6 months"|"No timeframe" purchasingTimeFrame?; string address?; string comments?; string city?; string org?; @jsondata:Name {value: "last_name"}
        string lastName?; @jsondata:Name {value: "no_of_employees"}
        ""|"1-20"|"21-50"|"51-100"|"101-250"|"251-500"|"501-1,000"|"1,001-5,000"|"5,001-10,000"|"More than 10,000" noOfEmployees?; string industry?; string phone?; @jsondata:Name {value: "role_in_purchase_process"}
        ""|"Decision Maker"|"Evaluator/Recommender"|"Influencer"|"Not involved" roleInPurchaseProcess?; string state?; @jsondata:Name {value: "first_name"}
        string firstName; @jsondata:Name {value: "job_title"}
        string jobTitle?; string email; "approved"|"denied"|"pending" status?; @jsondata:Name {value: "join_url"}
        string joinUrl?; @jsondata:Name {value: "create_time"}
        string createTime?; @jsondata:Name {value: "participant_pin_code"}
        int participantPinCode?; string status5?;}[] registrants?;
};
...
public type MeetingRegistrantMeetingRegistrantMeetingRegistrantAllOf123 record {
    ...
    "approved"|"pending"|"denied" status6?;
};
...
public type InlineResponse2003InlineResponse2003InlineResponse2003AllOf123 record {
    ...
    record {@jsondata:Name {value: "file_path"}
        string filePath?; @jsondata:Name {value: "play_url"}
        string playUrl?; @jsondata:Name {value: "file_name"}
        string fileName?; @jsondata:Name {value: "file_type"}
        string fileType?; @jsondata:Name {value: "download_url"}
        string downloadUrl?; string id?; @jsondata:Name {value: "file_size"}
        decimal fileSize?; @jsondata:Name {value: "recording_end"}
        string recordingEnd?; @jsondata:Name {value: "recording_start"}
        string recordingStart?; "completed" status?;}[] participantAudioFiles?;
};
...
public type CloudRecordingRegistrationList record {
    ...
    record {string id?; string zip?; string country?; @jsondata:Name {value: "custom_questions"}
        ...
        ""|"Decision Maker"|"Evaluator/Recommender"|"Influencer"|"Not involved" roleInPurchaseProcess?; string state?; @jsondata:Name {value: "first_name"}
        string firstName; @jsondata:Name {value: "job_title"}
        string jobTitle?; string email; "approved"|"denied"|"pending" status?;}[] registrants?;
};
...
public type InlineResponse2003InlineResponse2003AllOf12 record {
    ...
    # The cloud recording's passcode to be used in the URL. Directly splice this recording's passcode in `play_url` or `share_url` with `?pwd=` to access and play. Example: 'https://zoom.us/rec/share/**************?pwd=yNYIS408EJygs7rE5vVsJwXIz4-VW7MH'
    @jsondata:Name {value: "recording_play_passcode"}
    string recordingPlayPasscodeAlt?;
